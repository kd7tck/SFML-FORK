...
SFML is a simple, fast, cross-platform and object-oriented multimedia API. It provides access to windowing, graphics, audio, network, sqlite3, xml-parsing and lua scripting engine.
